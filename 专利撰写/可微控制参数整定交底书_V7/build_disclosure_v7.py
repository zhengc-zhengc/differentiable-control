"""Build V7 patent disclosure with polished flowchart and three-line tables."""
...
def generate_flow_diagram(path: Path) -> None:
    ...
    poly_arrow(
        ...
        [
            ...
            (500, center(steps["S9"][:4])[1]),
            (500, 920),
            (center(steps["S5"][:4])[0], 920),
    ...
    label_x = 500 + (center(steps["S5"][:4])[0] - 500 - (label_bbox[2] - label_bbox[0])) // 2
    draw.text((label_x, 875), label, fill="black", font=label_font)
    img.save(path)
