"""Build V6 patent disclosure with hybrid plant and MLP diagnostics."""
...
def generate_flow_diagram(path: Path) -> None:
    ...
    draw.text((580, 785), "控制器不足则继续整定；模型异常则检查 MLP 残差", fill="black", font=V3.font(20))
    img.save(path)
